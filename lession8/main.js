...
function myFunction($scope){
    $scope.a = "10"
    $scope.name =["Long","Bình","Hùng","Hoa"];
     // sale: true -> đang sale || fasle -> không sale : show hide
    // image: img -> src
    /**
...
function childrenFunction1($scope,$rootScope){
    $scope.mess1 = "Children1"
    $rootScope.root = "Root children1"
}

function childrenFunction2($scope){
    $scope.mess2 = "Children2"
}
app.controller("parentController",parentFunction)
app.controller("childrenController1",childrenFunction1)
app.controller("childrenController2",childrenFunction2)